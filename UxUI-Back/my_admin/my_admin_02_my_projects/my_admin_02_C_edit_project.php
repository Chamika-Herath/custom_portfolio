...
$page_title = "Modify Project Node · Heraforce Nexus";
...
<div data-page="projects" id="my_admin_02_C">
...
<div class="hera-app">
  ...
  <main class="hera-main">
    <div class="hera-breadcrumb">
      <div>Admin Network / Project Integrations / <span>Modify Node</span></div>
    ...
    <form class="hera-form-panel">
      ...
      <h2 class="hera-form-title">Modify Project Array</h2>
      <p class="hera-form-subtitle">Update telemetry and visual data for existing matrix assets.</p>

      <div class="hera-form-grid">
        
        <input type="hidden" id="proj_C_hidden_id" value="">
        <!-- Cover Art Zone -->
        <div class="hera-form-group">
          <label class="hera-form-label">Active Visual Pipeline</label>
          
          <!-- Upload State -->
          <div class="hera-file-zone" id="proj_C_cover_upload_state" onclick="document.getElementById('proj_C_file').click();">
            ...
            <div class="hera-file-text" id="proj_C_filename_txt">Drag New Image to Override</div>
            <div class="hera-file-subtext">Leave empty to keep existing Cover Art</div>
          </div>
          
          <input type="hidden" id="proj_C_remove_main_cover" value="0">
          
          <!-- Live Cover Art Preview Node -->
          <div id="proj_C_cover_preview_state" style="display:none; position:relative; width: 100%; border-radius: 12px; overflow: hidden; border: 1px solid var(--hera-border); aspect-ratio: 16/9; background: rgba(0,0,0,0.4);">
             <img id="proj_C_cover_preview_img" src="" style="width:100%; height:100%; object-fit:cover; opacity: 0.9;">
             <button type="button" id="proj_C_cover_remove_btn" onclick="removeMainCover_Edit()" style="position: absolute; top: 12px; right: 12px; background: rgba(0,0,0,0.8); color: #fff; border: 1px solid rgba(255,255,255,0.2); border-radius: 4px; padding: 6px 12px; font-size: 11px; cursor: pointer; backdrop-filter: blur(4px); transition:0.2s;">Remove Cover Image</button>
          </div>
          
          <input type="file" id="proj_C_file" style="display:none;" accept="image/*" onchange="renderMainCoverPreview_Edit(this);">
        </div>
        ...
        <div class="hera-form-group" style="margin-top: 10px;">
          ...
          <input type="text" id="proj_C_display_id" class="hera-input" disabled style="opacity: 0.5; background: rgba(0,0,0,0.2);">
        </div>

        <!-- Project Name -->
        <div class="hera-form-group">
          <label class="hera-form-label">Project Name</label>
          <input type="text" id="proj_C_name" class="hera-input">
        </div>

        <!-- Tech Stack / Client -->
        <div class="hera-form-group">
          <label class="hera-form-label">Client Name</label>
          <input type="text" id="proj_C_tech" class="hera-input">
        </div>

        <!-- Small Title Description -->
        <div class="hera-form-group">
          <label class="hera-form-label">Synopsis (Short Description)</label>
          <input type="text" id="proj_C_main_desc" class="hera-input">
        </div>
        
        <!-- Long Description -->
        <div class="hera-form-group">
          <label class="hera-form-label">Detailed Project Architecture</label>
          <textarea id="proj_C_long_desc" class="hera-input" style="min-height: 120px; resize: vertical;"></textarea>
        </div>

        <!-- Project URL -->
        <div class="hera-form-group">
          <label class="hera-form-label">Live Project URL</label>
          <input type="url" id="proj_C_project_url" class="hera-input">
        </div>

        <!-- SEO META: Keywords -->
        <div class="hera-form-group">
          <label class="hera-form-label">SEO Keywords</label>
          <input type="text" id="proj_C_seo_keywords" class="hera-input">
        </div>

        <!-- SEO META: Description -->
        <div class="hera-form-group">
          <label class="hera-form-label">SEO Meta Description</label>
          <textarea id="proj_C_seo_description" class="hera-input" style="min-height: 80px; resize: vertical;"></textarea>
        </div>
        ...
        <div style="display: flex; gap: 20px; margin-bottom: 20px;">
          <div class="hera-form-group" style="flex: 1; margin-bottom: 0;">
            ...
            <input type="color" id="proj_C_main_color" class="hera-input" style="height: 48px; padding: 5px; cursor: pointer;">
          </div>
          <div class="hera-form-group" style="flex: 1; margin-bottom: 0;">
            <label class="hera-form-label">Secondary Brand Color</label>
            <input type="color" id="proj_C_secondary_color" class="hera-input" style="height: 48px; padding: 5px; cursor: pointer;">
          </div>
        </div>
        ...
        <div class="hera-form-group" style="margin-top: 20px;">
          ...
          <div style="font-size:11px; color:var(--hera-text-dim); margin-bottom:10px;">Individually manage your existing assets or append new ones.</div>
          <div id="gallery_preview_array_edit" style="display: grid; grid-template-columns: repeat(auto-fill, minmax(100px, 1fr)); gap: 12px;">
            <!-- JS Inject Images or Existing Images Here -->
          </div>
          <input type="file" id="proj_C_gallery" multiple accept="image/*" style="display:none;" onchange="renderGalleryPreviews_Edit(this);">
        </div>
        ...
        <div class="hera-form-group">
           <label class="hera-form-label" style="display:flex; justify-content:space-between; align-items:center;">
             ...
             <button type="button" class="hera-btn-submit" onclick="addFeatureNode_Edit()" style="padding: 6px 14px; background: rgba(212,188,143,0.1); font-size:10px; color:var(--hera-gold);">+ Add New Feature Node</button>
           </label>
           <div style="font-size:11px; color:var(--hera-text-dim); margin-bottom:10px;">You can map over existing features or delete them from the UI.</div>
           <div id="feature_nodes_container_edit" style="display:flex; flex-direction:column; gap:16px;">
              <!-- JS Spawns Feature Cards Here During Data Load -->
           </div>
        </div>
        ...
        <div class="hera-form-group">
          ...
          <div class="hera-toggle-wrap">
            ...
            <label class="hera-toggle">
              <input type="checkbox" id="proj_C_show">
      ...
      <div class="hera-form-footer">
        <button type="button" class="hera-btn-submit" onclick="my_admin_02_C_SUBMIT();">
          <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M2.5 2v6h6M21.5 22v-6h-6"/><path d="M22 11.5A10 10 0 0 0 3.2 7.2L2.5 8"/><path d="M2 12.5a10 10 0 0 0 18.8 4.2l.7-.8"/></svg>
          Update Project Data
        </button>
      </div>
