...
<header class="erp-header">
    <div class="erp-header__title" style="color: var(--primary, #d1b88e); font-weight: 700;">Welcome To Heraforce & SLdrawing Dashboard</div>
    <div class="erp-header__icons">
        <span class="erp-header__icon" title="Go to Home" onclick="window.location.href='/index.php'">
