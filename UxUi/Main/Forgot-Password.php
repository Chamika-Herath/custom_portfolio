...
<head>
    ...
    <style>
        ...
        :root {
            /* Primary ERP Brand Colors - Bound to Heraforce Theme */
            --erp-primary: var(--primary, #d1b88e);
            --erp-primary-dark: #b59b71;
            --erp-primary-light: rgba(212, 188, 143, 0.6);
            --erp-primary-subtle: rgba(212, 188, 143, 0.1);

            /* Neutral Colors */
            --erp-surface: rgba(10, 12, 18, 0.85); /* Match login card base */
            --erp-surface-alt: rgba(255, 255, 255, 0.03);
            --erp-border: rgba(212, 188, 143, 0.3);
            --erp-border-dark: var(--primary);
            --erp-text-primary: #ffffff;
            --erp-text-secondary: rgba(255, 255, 255, 0.8);
            --erp-text-tertiary: rgba(255, 255, 255, 0.5);
        ...
        * {
        ...
        .erp-login-card {
            ...
            border: 1px solid rgba(212, 188, 143, 0.1);
        ...
        .erp-login-card__header {
            ...
            border-bottom: 1px solid rgba(212, 188, 143, 0.2);
            color: white;
        ...
        .erp-btn--primary {
            ...
            box-shadow: 0 10px 20px rgba(212,188,143,0.1);
        }
